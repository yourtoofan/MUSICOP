...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/yourtoofan/MUSICOP",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/LuckyJetAviatorGame")
SUPPORT_CHAT = getenv("SUPPORT_CHAT","https://t.me/+tqVHAVIOtCQ3ZmQ1")
